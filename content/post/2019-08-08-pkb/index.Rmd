...
I use a number of extension to make it much more useful for me. It turns out that most of the ones I still use today are included in [the Semantic Bundle](Semantic_Bundle), which I'll address in a minute. Here are the ones that _aren't_ included:
...
Using a combination of boilerplates and templates, I can easily start a new page for a class offering. We'll actually go through my fall 2019 ETCV 302 class here.
